...
<footer>
  <div class="foot-in">
    ...
    <span><a href="${config.sourceUrl}">Source on GitHub</a></span>
  </div>
</footer>
</body>
</html>
...
if (styleBlocks.length !== 4 || scriptBlocks.length !== 1) {
  throw new Error(
    `Expected four inline style blocks and one inline script; found ${styleBlocks.length} and ${scriptBlocks.length}`,
  );
}
